        ...
        public async Task<IActionResult> OnPost(IEnumerable<BasketItemViewModel> items)
        {
            try
            {
                ...
                await httpClient.PostAsync(
                    $"https://deliveryorderprocessorcloudx.azurewebsites.net/order/{BasketModel.Id}",
                ...
                await using ServiceBusSender sender = client.CreateSender(_configuration["QueueName"]);
                try
                {
                    var message = new ServiceBusMessage(new { Id = BasketModel.Id, Quantity = updateModel.Values }.ToJson());
